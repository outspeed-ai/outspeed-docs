...
import InstallOutspeedSnippet from "/snippets/install-outspeed.mdx";
  ...
  <Step title="Install Dependencies">
    ...
    <Step title="Run Backend">
      <Warning>
      Ensure you’re in the same directory as avatar_bot.py!
      </Warning>
      ...
      ```bash
      outspeed deploy --api-key=<your-api-key> avatar_bot.py
      ```
  ...
  <Step title="Run Demo">
    ...
    https://playground.outspeed.com/webrtc_input
...
Review the code in `avatar_bot.py`.
