...
# Example of updating the prompt and model for GroqLLM
...
# Example of updating the prompt and model for OpenAILLM
...
# Example of updating the prompt and model for FireworksLLM
