...
- The full GitHub repository is available [here.](https://github.com/outspeed-ai/outspeed.git) and examples are in the `/examples` directory
...
<Steps>
  ...
  <Step title="Integrate the Search Tool">
    ...
    ### **Setup API Keys (if running locally)**
      ...
      1. `EXA_API_KEY` - You can get this by visiting the [Exa API documentation](https://exa.ai/docs) and navigating to the API keys section to generate a new key.

      Once you have your key, run the following commands:
