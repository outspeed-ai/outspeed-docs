...
Context management allows you to create, retrieve, and delete items in the conversation's context during voice interactions. This gives you full control over what information the AI agent has access to.
