...
<div class="max-w-3xl mx-auto my-100">
  ...
  <CardGroup cols={3}>
    ...
    <Card title="Concepts" icon="book" href="/get-started/openai-compatibility">
      Learn the core ideas behind Outspeed's voice stack.
    </Card>
    <Card title="Pricing" icon="dollar-sign" href="https://dashboard.outspeed.com/pricing">
      See pricing for API and SDK usage.
    </Card>
  </CardGroup>
