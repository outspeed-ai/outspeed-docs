...
<div class="mt-0">
  <div class="flex flex-col lg:flex-row gap-8 items-center mb-12">
    <div class="flex-1 flex justify-center lg:justify-start">
      <img 
        src="../logo/outspeed-phone-blue-light.png" 
        alt="Outspeed Voice AI Platform" 
        class="docimage max-w-8 h-auto rounded-lg shadow-lg dark:hidden"
      />
      <img 
        src="../logo/outspeed-phone-blue.png" 
        alt="Outspeed Voice AI Platform" 
        class="docimage max-w-8 h-auto rounded-lg shadow-lg hidden dark:block"
      />
    </div>
    <div class="flex-1">
  ...
  <CardGroup cols={2}>
    <Card title="HR" icon="user-tie" href="https://outspeed.com/dashboard">
      Voice agent for HR interviews and onboarding.
    </Card>
    <Card title="Therapist" icon="user-nurse" href="https://outspeed.com/dashboard">
      Empathetic voice agent for therapy and support.
    </Card>
    <Card title="Companion" icon="user-secret" href="https://outspeed.com/dashboard">
