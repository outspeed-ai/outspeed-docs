...
>
  Test and compare different speech-to-speech systems with our interactive Voice DevTools.
...
The Voice DevTools gives ability to test a prompt with different speech to speech models. Supported models are:
  ...
  2. [Outspeed (with Orpheus + Llama4)](/models/outspeed) hosted by Outspeed
  3. [Gemini Multimodal Live](https://ai.google.dev/gemini-api/docs/multimodal-live) `coming soon`

## Usage

The Voice DevTools provides a simple interface to test and interact with various speech-to-speech systems:
...
4. Receive realtime audio responses from the model
...
- **Realtime Processing**: Experience low-latency voice conversations with automatic speech detection
