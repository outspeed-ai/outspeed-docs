...
description: "Test out different speech-to-speech models with Speech Console"
---
<Card
  title="Speech Console"
  icon="github"
...
<Note>
  Speech Console is based on OpenAI's realtime console.
</Note>

The Speech Console gives ability to test a prompt with different speech to speech models. Supported models are:
...
The Speech Console provides a simple interface to test and interact with various speech-to-speech models:
...
The Speech Console offers several key features:
