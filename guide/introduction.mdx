...
1. **`rt.App`**: The main application class that encapsulates your entire application logic. This is what's deployed on Outspeed cloud and scales based on the number of concurrent connections
to the endpoint.
