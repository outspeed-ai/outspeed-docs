...
<ResponseField name="<RealtimeForm />">
A styled form component.
</ResponseField>

<ResponseField name="<RealtimeFunctionURLInput />">
A styled input component for entering the function URL.
</ResponseField>

<ResponseField name="<RealtimeAudioInput />">
...
<ResponseField name="<RealtimeVideoInput />">
...
<ResponseField name="<RealtimeFormButton />">
