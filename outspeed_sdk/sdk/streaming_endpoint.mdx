...
<Info>Note the type hints in the function’s arguments. These are strictly required. Type hints are picked up by the realtime package, and are used to generate the streams.</Info>
