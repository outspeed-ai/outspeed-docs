...
| python_packages | List[str] | Specifies additional Python packages to be installed | Default is determined by the system |
| system_packages | List[str] | Specifies additional system packages to be installed | Default is determined by the system |
